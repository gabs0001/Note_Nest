<template>
    <div class="flex bg-zinc-900 h-screen">
        ...
        <!-- sidebar -->
        <div class="bg-black w-[290px] p-8 flex flex-col overflow-scroll">
            <div>
                <Logo />
            </div>
                ...
                <div class="ml-2 space-y-2">
                    ...
                    >
                        ...
                        <div class="leading-none truncate text-[#d6d6d6]">
                            <span class="text-xm text-[#f4f4f5] mr-4">
...
<script setup>
    ...
    async function deleteNote() {
        const { isConfirmed } = await Swal.fire({
            title: 'Are you sure?',
            text: 'This will delete your note permanently, are you sure you like to do this?',
            icon: 'warning',
    ...
    const debouncedFn = useDebounceFn(async () => { await updateNote() }, 1000)
